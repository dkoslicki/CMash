...
if __name__ == '__main__':
	...
	out_queue = multiprocessing.Manager().dict()  # TODO: consider using a pipe
	ps = list()
	...
	print("length of out queue %d" % len(out_queue))
	#match_tuples = set(out_queue)
	match_tuples = out_queue.keys()
